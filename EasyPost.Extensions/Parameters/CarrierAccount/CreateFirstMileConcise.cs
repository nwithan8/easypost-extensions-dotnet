...
{
    /// <summary>
    ///     Parameters for First Mile Concise <see cref="EasyPost.Models.API.CarrierAccount"/> creation API calls.
    /// </summary>
    public class CreateFirstMileConcise : CreateCustom
    {
        ...
        /// <summary>
        ///     Construct a new set of <see cref="CreateFirstMileConcise"/> parameters.
        /// </summary>
        public CreateFirstMileConcise() : base(Constants.CarrierAccountTypes.FirstMileConcise)
        {
        }
    }
}
