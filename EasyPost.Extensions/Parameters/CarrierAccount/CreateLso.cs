...
{
    /// <summary>
    ///     Parameters for LSO <see cref="EasyPost.Models.API.CarrierAccount"/> creation API calls.
    /// </summary>
    public class CreateLso : CreateCustom
    {
        ...
        /// <summary>
        ///     Construct a new set of <see cref="CreateLso"/> parameters.
        /// </summary>
        public CreateLso() : base(Constants.CarrierAccountTypes.Lso)
        {
        }
    }
}
