...
{
    /// <summary>
    ///     Parameters for Sonic <see cref="EasyPost.Models.API.CarrierAccount"/> creation API calls.
    /// </summary>
    public class CreateSonic : CreateCustom
    {
        ...
        /// <summary>
        ///     Construct a new set of <see cref="CreateSonic"/> parameters.
        /// </summary>
        public CreateSonic() : base(Constants.CarrierAccountTypes.Sonic)
        {
        }
    }
}
