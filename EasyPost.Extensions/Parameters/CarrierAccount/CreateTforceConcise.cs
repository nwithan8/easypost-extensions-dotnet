...
{
    /// <summary>
    ///     Parameters for T-Force Concise <see cref="EasyPost.Models.API.CarrierAccount"/> creation API calls.
    /// </summary>
    public class CreateTforceConcise : CreateCustom
    {
        ...
        /// <summary>
        ///     Construct a new set of <see cref="CreateTforceConcise"/> parameters.
        /// </summary>
        public CreateTforceConcise() : base(Constants.CarrierAccountTypes.TForceConcise)
        {
        }
    }
}
