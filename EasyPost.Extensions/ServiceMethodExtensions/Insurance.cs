...
public static class InsuranceServiceExtensions
{
    ...
    /// <param name="parameters">The <see cref="Parameters.Insurance.All"/> parameters to use for the API call.</param>
    ...
    /// </summary>
    /// <param name="service">The <see cref="EasyPost.Services.InsuranceService"/> to use for the API call.</param>
    /// <param name="parameters">The <see cref="Parameters.Insurance.Create"/> parameters to use for the API call.</param>
    /// <param name="apiVersion">The <see cref="ApiVersion"/> to target.</param>
