...
build-test-fw:
	dotnet msbuild EasyPost.Extensions.Tests/EasyPost.Extensions.Tests.csproj -property:Configuration="Debug" -target:Rebuild -restore -property:TargetFramework=${fw}
...
scan:
	dotnet tool run security-scan --verbose --no-banner --ignore-msbuild-errors EasyPost.Extensions.sln
...
test-fw:
	...
	dotnet test EasyPost.Extensions.Tests/EasyPost.Extensions.Tests.csproj -f ${fw}
